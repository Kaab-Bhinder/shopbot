  ...
  useEffect(() => {
    ...
    fetch('/api/categories')
      ...
      .then(data => {
        ...
        setCategories(data.filter((cat: { sex: string }) => cat.sex === 'Men' || cat.sex === 'Unisex'));
      });
  }, []);
    ...
    return (
      <div className="min-h-screen bg-gray-50 py-8">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <h1 className="text-4xl font-bold text-gray-900 mb-4">Men&apos;s Collection</h1>
            <p className="text-gray-600">No men&apos;s products available at the moment.</p>
          </div>
        </div>
      </div>
    );
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {products.length === 0 && (
          <div className="text-center py-16">
            ...
            <h3 className="text-xl font-semibold text-gray-900 mb-2">No Men&apos;s Products Found</h3>
